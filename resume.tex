...
\usepackage{verbatim}
\usepackage{enumitem}
\usepackage[hidelinks,pdfauthor={Sami Warraich},
    pdftitle={Resume | Sami Warraich},
    pdfsubject={Full Stack Developer Resume},
    pdfkeywords={React, Node.js, JavaScript, Full Stack Developer, Resume, Sami Warraich}]{hyperref}
\usepackage{fancyhdr}
